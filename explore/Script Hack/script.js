...
class Utilities {
    ...
    onLoad() {
        ...
        .set('Self', [this.newFeature('AutoBhop', ['Off', 'Auto Jump', 'Auto Slide']), /*this.newFeature('NoDeathDelay', ['Off', 'On']),*/ this.newFeature('ZaRes X Settings', ['Off', 'On'])])
    ...
    resetSettings() {
        if (confirm("Are you sure you want to reset all your ZaRes X settings? This will also refresh the page")) {
